...
public class ZObject implements TruffleObject {
	...
	/**
	 * {@link ZObject} values are seen as objects with the IDs of their keys by other languages.
	 * That is, other languages always see keys like “Z10K1”, not “head”.
	 * @param booleanInternal Ignored, we have no internal keys.
	 */
	@ExportMessage
	public String[] getMembers(boolean includeInternal) {
		// TODO apparently the below call ends up calling methods that must not be part of compilation
